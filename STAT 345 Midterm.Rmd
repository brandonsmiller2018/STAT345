...
ggplot(data=drafts_mvp_count, aes(x=numberPickOverall, y=count)) + geom_bar(stat = "identity")+labs(title="Total Number of MVPs for Each Overall Draft Selection", x="Overall Pick", y="Number of MVPs")
```
